...
export function inspectorCloudProcedures(env: Env, userId: string, requireSubscription: () => Promise<void>) {
  ...
  return {
    bootstrap, transcript, transcriptPage, transcriptContent, availability, overview,
