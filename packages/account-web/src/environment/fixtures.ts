...
export const environmentFixture: EnvironmentViewModel = {
  ...
  ledger: {
    ...
    runs: [
      { id: 'materialize-2', projectId: 'gitspace', spaceId: 'agent-blame', phase: 'workspace/materialize', status: 'failed', profile: 'backend', machineId: 'local-machine', generation: 2, executionHashes: ['sha256:be81bbca'], terminalName: null, results: [{ id: 'workspace/materialize/20-db.sh', exitCode: 1, output: 'Migration 0006 failed: database connection refused.' }], output: 'Migration 0006 failed: database connection refused.\\nProvisioned database and endpoint are unchanged.', exitCode: 1, startedAt: '2026-09-05T12:00:00.000Z', finishedAt: '2026-09-05T12:00:18.000Z' },
      { id: 'provision-1', projectId: 'gitspace', spaceId: 'agent-blame', phase: 'cloud/provision', status: 'succeeded', profile: 'backend', machineId: 'studio', generation: null, executionHashes: [], terminalName: null, results: [], output: 'Created preview-agent-blame. Resource bindings saved.', exitCode: 0, startedAt: '2026-09-01T11:59:30.000Z', finishedAt: '2026-09-01T12:00:00.000Z' },
    ],
  },
  secrets: [
