  ...
  return <GallerySection id="primitives" index="01" title="Primitives" description="Buttons, badges, fields, menus, and the dialog — every control rides the same 36px ladder, press geometry, and weight transitions.">
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      <Demo title="Button — variants, sizes, states">
        ...
        <Row><Button variant="primary" size="compact">Compact</Button><Button variant="secondary" size="compact" leadingIcon={icons.plus}>New workspace</Button><Button variant="secondary" trailingIcon={icons['chevron-down']}>Model</Button><Button variant="primary">Continue <ArrowUpRight /></Button></Row>
        <Row>
      ...
      <Demo title="Badge — colors and variants">
        ...
        <Row><Badge variant="dot" color="green">Online</Badge><Badge variant="dot" color="orange">Away</Badge><Badge variant="dot" color="gray">Offline</Badge><Badge size="compact" color="teal">compact</Badge><Badge size="compact" variant="dot" color="pink">compact dot</Badge><Badge color="violet"><Zap /> Self-modifying</Badge></Row>
