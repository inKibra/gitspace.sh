...
let mockHubTerminals: WorkspaceTerminalView[] = [
  { spaceId: 'workspace-a', name: 'life-move-7', id: 'hub-1', kind: 'lifecycle', state: 'running', machineId: 'build-machine', owner: 'gitspace:workspace-a:lifecycle', command: '.gitspace/lifecycle/machine/prepare/01-dependencies.sh', cwd: '/workspace/agent-blame', createdAt: new Date(), exitCode: null },
