/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: a0a45964906196da2effe35937a5ed87)
// Runtime types generated with workerd@1.20260826.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	SANDBOX_HOSTNAME: "sandboxes.gitspace.sh";
	Sandbox: DurableObjectNamespace<import("./src/index").GitSpaceSandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GitSpaceSandbox";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANDBOX_HOSTNAME">> {}
}
